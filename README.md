...
em soluções robustas, seguras e orientadas a dados.

---

## Tecnologias-chave

- .NET (APIs, sistemas corporativos e aplicações backend)
- Python (automação, backend e integração)
...
Atuo há vários anos na área de tecnologia da informação, trabalhando no desenvolvimento
e na sustentação de sistemas que exigem estabilidade, organização e capacidade de
crescimento a longo prazo.

Minha experiência une a vivência em ambientes institucionais, com foco em infraestrutura
e suporte técnico, ao desenvolvimento de software sob demanda para empresas e projetos
de diferentes setores, sempre buscando equilíbrio entre performance, segurança e
manutenibilidade.
...
Acredito que bons sistemas devem ser simples na superfície e sólidos na arquitetura.
